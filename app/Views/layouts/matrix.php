...
<html dir="ltr" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/templates/matrix-admin/assets/libs/flot/css/float-chart.css">
    <!-- Custom CSS -->
    <!-- <link href="../dist/css/style.min.css" rel="stylesheet" /> -->
    <link rel="stylesheet" href="/templates/matrix-admin/dist/css/style.min.css">
  ...
  <body>
    ...
    >
        ...
        <nav class="navbar top-navbar navbar-expand-md navbar-dark">
          <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand m-0 p-0" href="/">
                <h4 class="m-0 p-0 mx-auto">Books Store</h4>
            </a>
            <!-- ============================================================== -->
            <!-- End Logo -->
            <!-- ============================================================== -->
      ...
      <!-- ============================================================== -->
        ...
        <!-- ============================================================== -->
    <footer>
      <h6 class="text-center mt-4">All Rights Reserved by Matrix-admin. Designed and Developed by<a href="https://www.wrappixel.com">WrapPixel</a>.</h6>
    </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
    <!-- ============================================================== -->
